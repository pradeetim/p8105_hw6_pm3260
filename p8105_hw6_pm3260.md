...
fit_3 = lm(bwt ~ bhead * blength * babysex, data = birthweight_df)
```
...
```
    ...
    ## ℹ In argument: `rmse_model_1 = map2_dbl(fit_1, test, rmse)`.
...
![](p8105_hw6_pm3260_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
